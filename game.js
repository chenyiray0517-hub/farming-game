...
const LEVELS = [
  ...
  // ── 101–150 ─────────────────────────────────────────────────────
  { level:101, xp:762500,   title:'天地農神' },
  { level:102, xp:778700,   title:'天地農神二段' },
  { level:103, xp:793050,   title:'天地農神三段' },
  { level:104, xp:808550,   title:'天地農神四段' },
  { level:105, xp:824200,   title:'天地農神五段' },
  { level:106, xp:840000,   title:'宇宙農仙' },
  ...
  { level:114, xp:971800,   title:'神話農王四段' },
  { level:115, xp:988950,   title:'神話農王五段' },
  { level:116, xp:1006250,  title:'超凡農聖' },
  ...
  { level:124, xp:1150050,  title:'農道至尊四段' },
  { level:125, xp:1168700,  title:'農道至尊五段' },
  { level:126, xp:1187500,  title:'不滅農神' },
  { level:127, xp:1206450,  title:'不滅農神二段' },
  { level:128, xp:1225550,  title:'不滅農神三段' },
  { level:129, xp:1244800,  title:'不滅農神四段' },
  { level:130, xp:1264200,  title:'不滅農神五段' },
  { level:131, xp:1283750,  title:'永恆農帝' },
  { level:132, xp:1303450,  title:'永恆農帝二段' },
  { level:133, xp:1323300,  title:'永恆農帝三段' },
  { level:134, xp:1343300,  title:'永恆農帝四段' },
  { level:135, xp:1363450,  title:'永恆農帝五段' },
  { level:136, xp:1383750,  title:'造化農祖' },
  { level:137, xp:1404200,  title:'造化農祖二段' },
  { level:138, xp:1424800,  title:'造化農祖三段' },
  { level:139, xp:1445550,  title:'造化農祖四段' },
  { level:140, xp:1466450,  title:'造化農祖五段' },
  { level:141, xp:1487500,  title:'混沌農皇' },
  { level:142, xp:1508700,  title:'混沌農皇二段' },
  { level:143, xp:1530050,  title:'混沌農皇三段' },
  { level:144, xp:1551550,  title:'混沌農皇四段' },
  { level:145, xp:1573200,  title:'混沌農皇五段' },
  { level:146, xp:1595000,  title:'太古農尊' },
  { level:147, xp:1616950,  title:'太古農尊二段' },
  { level:148, xp:1639050,  title:'太古農尊三段' },
  { level:149, xp:1661300,  title:'太古農尊四段' },
  { level:150, xp:1683700,  title:'創世農神' },
  // ── 151–250 ─────────────────────────────────────────────────────
  { level:151, xp:1706250,  title:'混元農神' },
  { level:152, xp:1728950,  title:'混元農神二段' },
  { level:153, xp:1751800,  title:'混元農神三段' },
  { level:154, xp:1774800,  title:'混元農神四段' },
  { level:155, xp:1797950,  title:'混元農神五段' },
  { level:156, xp:1821250,  title:'混元農神六段' },
  { level:157, xp:1844700,  title:'混元農神七段' },
  { level:158, xp:1868300,  title:'混元農神八段' },
  { level:159, xp:1892050,  title:'混元農神九段' },
  { level:160, xp:1915950,  title:'混元農神十段' },
  { level:161, xp:1940000,  title:'虛空農皇' },
  { level:162, xp:1964200,  title:'虛空農皇二段' },
  { level:163, xp:1988550,  title:'虛空農皇三段' },
  { level:164, xp:2013050,  title:'虛空農皇四段' },
  { level:165, xp:2037700,  title:'虛空農皇五段' },
  { level:166, xp:2062500,  title:'虛空農皇六段' },
  { level:167, xp:2087450,  title:'虛空農皇七段' },
  { level:168, xp:2112550,  title:'虛空農皇八段' },
  { level:169, xp:2137800,  title:'虛空農皇九段' },
  { level:170, xp:2163200,  title:'虛空農皇十段' },
  { level:171, xp:2188750,  title:'洪荒農祖' },
  { level:172, xp:2214450,  title:'洪荒農祖二段' },
  { level:173, xp:2240300,  title:'洪荒農祖三段' },
  { level:174, xp:2266300,  title:'洪荒農祖四段' },
  { level:175, xp:2292450,  title:'洪荒農祖五段' },
  { level:176, xp:2318750,  title:'洪荒農祖六段' },
  { level:177, xp:2345200,  title:'洪荒農祖七段' },
  { level:178, xp:2371800,  title:'洪荒農祖八段' },
  { level:179, xp:2398550,  title:'洪荒農祖九段' },
  { level:180, xp:2425450,  title:'洪荒農祖十段' },
  { level:181, xp:2452500,  title:'無極農尊' },
  { level:182, xp:2479700,  title:'無極農尊二段' },
  { level:183, xp:2507050,  title:'無極農尊三段' },
  { level:184, xp:2534550,  title:'無極農尊四段' },
  { level:185, xp:2562200,  title:'無極農尊五段' },
  { level:186, xp:2590000,  title:'無極農尊六段' },
  { level:187, xp:2617950,  title:'無極農尊七段' },
  { level:188, xp:2646050,  title:'無極農尊八段' },
  { level:189, xp:2674300,  title:'無極農尊九段' },
  { level:190, xp:2702700,  title:'無極農尊十段' },
  { level:191, xp:2731250,  title:'盤古農帝' },
  { level:192, xp:2759950,  title:'盤古農帝二段' },
  { level:193, xp:2788800,  title:'盤古農帝三段' },
  { level:194, xp:2817800,  title:'盤古農帝四段' },
  { level:195, xp:2846950,  title:'盤古農帝五段' },
  { level:196, xp:2876250,  title:'盤古農帝六段' },
  { level:197, xp:2905700,  title:'盤古農帝七段' },
  { level:198, xp:2935300,  title:'盤古農帝八段' },
  { level:199, xp:2965050,  title:'盤古農帝九段' },
  { level:200, xp:2994950,  title:'盤古農帝十段' },
  { level:201, xp:3025000,  title:'九天農仙' },
  { level:202, xp:3055200,  title:'九天農仙二段' },
  { level:203, xp:3085550,  title:'九天農仙三段' },
  { level:204, xp:3116050,  title:'九天農仙四段' },
  { level:205, xp:3146700,  title:'九天農仙五段' },
  { level:206, xp:3177500,  title:'九天農仙六段' },
  { level:207, xp:3208450,  title:'九天農仙七段' },
  { level:208, xp:3239550,  title:'九天農仙八段' },
  { level:209, xp:3270800,  title:'九天農仙九段' },
  { level:210, xp:3302200,  title:'九天農仙十段' },
  { level:211, xp:3333750,  title:'萬界農王' },
  { level:212, xp:3365450,  title:'萬界農王二段' },
  { level:213, xp:3397300,  title:'萬界農王三段' },
  { level:214, xp:3429300,  title:'萬界農王四段' },
  { level:215, xp:3461450,  title:'萬界農王五段' },
  { level:216, xp:3493750,  title:'萬界農王六段' },
  { level:217, xp:3526200,  title:'萬界農王七段' },
  { level:218, xp:3558800,  title:'萬界農王八段' },
  { level:219, xp:3591550,  title:'萬界農王九段' },
  { level:220, xp:3624450,  title:'萬界農王十段' },
  { level:221, xp:3657500,  title:'超脫農聖' },
  { level:222, xp:3690700,  title:'超脫農聖二段' },
  { level:223, xp:3724050,  title:'超脫農聖三段' },
  { level:224, xp:3757550,  title:'超脫農聖四段' },
  { level:225, xp:3791200,  title:'超脫農聖五段' },
  { level:226, xp:3825000,  title:'超脫農聖六段' },
  { level:227, xp:3858950,  title:'超脫農聖七段' },
  { level:228, xp:3893050,  title:'超脫農聖八段' },
  { level:229, xp:3927300,  title:'超脫農聖九段' },
  { level:230, xp:3961700,  title:'超脫農聖十段' },
  { level:231, xp:3996250,  title:'大道農神' },
  { level:232, xp:4030950,  title:'大道農神二段' },
  { level:233, xp:4065800,  title:'大道農神三段' },
  { level:234, xp:4100800,  title:'大道農神四段' },
  { level:235, xp:4135950,  title:'大道農神五段' },
  { level:236, xp:4171250,  title:'大道農神六段' },
  { level:237, xp:4206700,  title:'大道農神七段' },
  { level:238, xp:4242300,  title:'大道農神八段' },
  { level:239, xp:4278050,  title:'大道農神九段' },
  { level:240, xp:4313950,  title:'大道農神十段' },
  { level:241, xp:4350000,  title:'終極農尊' },
  { level:242, xp:4386200,  title:'終極農尊二段' },
  { level:243, xp:4422550,  title:'終極農尊三段' },
  { level:244, xp:4459050,  title:'終極農尊四段' },
  { level:245, xp:4495700,  title:'終極農尊五段' },
  { level:246, xp:4532500,  title:'終極農尊六段' },
  { level:247, xp:4569450,  title:'終極農尊七段' },
  { level:248, xp:4606550,  title:'終極農尊八段' },
  { level:249, xp:4643800,  title:'終極農尊九段' },
  { level:250, xp:4681200,  title:'農之始祖' },
];
...
const ACHIEVEMENTS = {
  ...
  level_150:       { name:'🌌 創世農神',   desc:'達到 Lv.150',                 xp:5000, check: s => s.player.level >= 150 },
